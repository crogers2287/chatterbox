...
if torch.cuda.is_available():
    # When using CUDA_VISIBLE_DEVICES, the device is always 0 from PyTorch's perspective
    DEVICE = "cuda:0"
    ...
    try:
        ...
        for i, audio_url in enumerate(request.audio_urls):
            try:
                ...
                logger.error(f"Error downloading audio {audio_url}: {e}")
